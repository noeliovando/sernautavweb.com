...
class crud{
    ...
    public function articulos()
    {
        ...
        if(isseT($_POST['buscar'])){
            ...
            $this->general= mysqli_query("SELECT * FROM madrid  WHERE descripcion  LIKE '%$buscar%'  ",$this->db_conexion);
        ...
        elseif(isset($_GET['ca'])){
            ...
            $this->general= mysqli_query("SELECT * FROM madrid  WHERE categoria='$ca'  ",$this->db_conexion);

        }
        else{
            $this->general= mysqli_query("SELECT * FROM madrid ",$this->db_conexion);
...
";
                $this->datos= mysqli_query("SELECT * FROM madrid   WHERE  descripcion='zxxxz'   ",$this->db_conexion);
            }else{
                $this->datos= mysqli_query("SELECT * FROM madrid WHERE descripcion  LIKE '%$buscar%'  ORDER BY id ASC  ",$this->db_conexion);
        ...
        elseif(isseT($_POST['min'])){
            ...
            $this->datos= mysqli_query("SELECT * FROM madrid WHERE precio  BETWEEN $min AND $max  ORDER BY id ASC  ",$this->db_conexion);
        ...
        elseif(isseT($_GET['ca'])){
            ...
            $this->datos= mysqli_query("SELECT * FROM madrid WHERE categoria='$ca'   ORDER BY id ASC  ",$this->db_conexion);
            ...
            $this->datos= mysqli_query("SELECT * FROM madrid WHERE paginacion  BETWEEN $dos AND $uno  ORDER BY id ASC LIMIT 32 ",$this->db_conexion);
...
";
    ...
    public function articulos2()
    {
        ...
        if( mysqli_num_row($this->datos)>0){
...
";
    ...
    public function articulos3()
    {
        ...
        $this->datos3= mysqli_query("SELECT * FROM  madrid ORDER BY RAND()  LIMIT 5 ",$this->db_conexion);
...
";
    ...
    public function articulos4()
    {
        ...
        $this->datos4= mysqli_query("SELECT * FROM madrid ORDER BY RAND()  LIMIT 6  ",$this->db_conexion);
...
";
    ...
    public function articulos5()
    {
        ...
        $this->carro= mysqli_query("SELECT *FROM compras  WHERE usuario='".$this->ip."' AND enviado!='1'  ",$this->db_conexion);
        ...
        $this->carro2= mysqli_query("SELECT * FROM madrid WHERE  id='".$this->articulo."'  ",$this->db_conexion);
        ...
        if($this->nume>0){
            ...
            $this->datos3= mysqli_query("SELECT * FROM  madrid WHERE categoria='".$this->catego."' ORDER BY RAND()  LIMIT 5 ",$this->db_conexion);
        }else{
...
";
    ...
    public function categoria3()
    {
        ...
        $this->datos2= mysqli_query("SELECT * FROM madrid  ORDER BY RAND() LIMIT 3 ",$this->db_conexion);
  ...
  <a href='?vista=producto.php&id=".$this->id3."' class='view-details-link'><i class='fa fa-link'></i>  Ver articulo</a>
    ...
    public function carrito()
    {
        ...
        while($this->row3= mysqli_fetch_array($this->carro))
        {
            ...
            $this->carro2= mysqli_query("SELECT * FROM madrid WHERE id='".$this->arti."' ",$this->db_conexion);
...
";
    ...
    public function carrotabla(){
        ...
        while($this->row4= mysqli_fetch_array($this->carro))
        {
            ...
            $this->carro2= mysqli_query("SELECT * FROM madrid WHERE  id='".$this->articulo2."'  ",$this->db_conexion);
...
//////////
    ...
    public function addorden(){
        ...
        IF(isset($_POST['nombre'])){
            ...
            $this->insertar2= mysqli_query("INSERT INTO orden (nombre,direccion,telefono,correo,lng,lat,monto,usuario,numero,estado) VALUES ('$nombre','$direccion','$telefono','$correo','$lng','$lat','$monto','".$this->ip."','".$this->azar."','0') ",$this->db_conexion);


            mysqli_Query("UPDATE compras SET enviado='1' WHERE usuario='".$this->ip."' AND enviado='' ",$this->db_conexion);
            mysqli_Query("UPDATE compras SET numero='".$this->azar."' WHERE usuario='".$this->ip."' AND enviado='1' AND numero='' ",$this->db_conexion);
...
////////////////
    ...
    public function articulosimple(){
        ...
        if(isset($_GET['id'])){
            ...
            $this->simple= mysqli_query("SELECT * FROM madrid WHERE id='$id' ",$this->db_conexion);
...
///////////////
    ...
    public function buscarpe(){
        ...
        if(isset($_POST['usuario'])){
            ...
            $this->validar= mysqli_query("SELECT * FROM orden WHERE correo='$usuario' AND numero='$clave' ",$this->db_conexion);
