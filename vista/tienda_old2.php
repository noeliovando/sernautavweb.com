...
<html lang="en">
  <head>
    ...
    <title>sernautavweb - Tienda</title>
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="http://sernautavweb.com/">sernautavweb<span>toys</span></a></h1>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="navbar-header">
                 ...
                 <ul class="nav navbar-nav">
                     <li class="active"><a href="http://sernautavweb.com/">Inicio</a></li>
                     <li><a href="sernautavweb.com/vista/tienda.php?vista=tienda.php">Tienda</a></li>
                     <li><a href="sernautavweb.com/vista/contacto.php?vista=contacto.php">Contacto</a></li>
                    </ul>
                </div>  
            </div>
        </div>
...
<h5> <a href='?vista=tienda.php&pg=1&ca=1'> Real madrid </a></h5>

<h5> <a href='?vista=tienda.php&pg=1&ca=2'> Atletico de madrid </a></h5>
...
<input type='text' name='buscar'  class='form-control' div style=Width:90%;margin-left:2%; placeholder='Articulo..'  />
...
<span div style=float:right;> <strong> Xiritoys.com </strong> 
...
<img src='../img/logo3.jpg' div style=Width:120px;height:120px; />
<h2> Black friday !  </h2>
<label> (Tiempo limitado) </label>
<br>
<span> 
Black friday llega con increibles descuentos en xiritoys, no dejes de aprovecharlos </span>
