                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-md-offset-6">
                                            <div class="slide-content">
                                                <h2>Xiritoys</h2>
                                                <p>
                                                    En Xiritoys podras conseguir un sin fin de  items referentes a los equipos de fubotl, Real madrid y atletico de madrid,  si eres fanatico de estos equipos no puedes dejar de visitar nuestra tienda online
                                                </p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                   ...
                   <p> 
                   Tu envio te llegara al sitio donde indiques,por agencia de transporte, en el plazo maximo de 48 horas.
			Tu compra, se realiza de forma segura, mediante SSL.
			Si tienes alguna duda, llamanos al tfno.-645 255 426, o escribenos un email, sernautavweb@gmail.com. 
                   </p>
  ...
  <?php $crud->categoria2(); ?> 
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                      <h2><a href="?vista=index.php">sernautavweb<span>toys</span></a></h2>
                        <p>Todos nuestros productos han sido testeados por los fabricantes, para ofrecerte una estupenda satisfaccion de uso</p>
    ...
    <div class="footer-bottom-area">
        <div class="container">
			...
			<p>Sernauta Virtual Web S.L.U.</p>
			<p>Dolores Almeda 10, 08940 Cornella de Llobregat, Barcelona</p>
			<p>CIF.-B66937350</p>
                    </div>
                </div>
