...
$this->insertar=mysql_query("INSERT INTO mensajes (nombre,telefono,correo,descripcion,articulo,visto) VALUES ('$nombre','$telefono','$correo','$descripcion','0','1')  ",$this->db_conexion);
...
$contactar->conectar('mysql.hostinger.es','u565655629_antuk','mGcLfN7E','u565655629_usato.madrid');
$contactar->con(); 
