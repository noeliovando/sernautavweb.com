...
if($this->visto==1){
    ...
    echo ' <td><a   href="?vista=admin.php&mena='.$this->id.'" target="blank" >  <img src="https://image.flaticon.com/icons/png/512/55/55413.png" div id="pc" /> </a></td>';
...
$bandeja= new bandeja();
$bandeja->conectar('mysql.hostinger.es','u565655629_antuk','mGcLfN7E','u565655629_usato.madrid');
$bandeja->mensajeria();
